...
folder `angular-ww2-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-ww2-snapshots` folder, containing
...
The chapter data used by the application is scraped from a Google search page.

- ScrapeData.js: Run this script using node.js to access the web page containing the chapter data and
  copy the data into the `app/chapters` folder.
