...
ww2Controllers.directive('modalDialog', function() {
  return {
    ...
    template: "<div class='ng-modal' ng-show='show'><div class='ng-modal-overlay'></div><div class='ng-modal-dialog' ng-style='dialogStyle'><img src='assets/images/back_arrow.png' ng-click='hideModal()'><div class='ng-modal-dialog-content' ng-transclude></div></div></div>"
